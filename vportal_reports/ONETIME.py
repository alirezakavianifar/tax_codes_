...
files = list_files(
    directory=r'E:\automating_reports_V2\automation\vportal_reports\onetime', extension='sql')
...
for file in files:
    ...
    try:
        with open(file, 'r', encoding='utf-8') as sql_file:
            ...
            df_mash = df_mash.astype(str)
            drop_into_db('tblMashGhabrboash',
