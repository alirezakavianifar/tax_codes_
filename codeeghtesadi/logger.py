...
import math
import pyodbc
from automation.helpers import get_update_date, remove_excel_files


log_folder_name = r'E:\automating_reports_V2\saved_dir\codeghtesadi\adam'
log_excel_name = r'excel_adam.xlsx'
...
def log_it(func):
    ...
    def try_it(*args, **kwargs):
        ...
        df_1 = pd.DataFrame([[rahgiri, success]], columns=[
                            'rahgiri', 'success'])
