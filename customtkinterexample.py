...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.logo_label = customtkinter.CTkLabel(
            self.sidebar_frame, text="CustomTkinter", font=customtkinter.CTkFont('Tahoma', size=20, weight="bold"))
        self.logo_label.grid(row=0, column=0, padx=20, pady=(20, 10))

        self.sidebar_button_1 = customtkinter.CTkButton(
            self.sidebar_frame,
            command=lambda: btn_handler(
                soratmoamelat, 'soratmoamelat'),
            text='صورت معاملات',
        ...
        self.sidebar_button_2 = customtkinter.CTkButton(
            self.sidebar_frame,
            command=lambda: btn_handler(
                arzesh, 'arzeshafzoodeh'),
            text='ارزش افزوده',
            font=customtkinter.CTkFont('Tahoma', size=15, weight="bold"))
        self.sidebar_button_2.grid(row=2, column=0, padx=20, pady=10)

        self.sidebar_button_3 = customtkinter.CTkButton(
            self.sidebar_frame, command=lambda: btn_handler(
                mash, 'mash'),
            text='مشاغل',
            font=customtkinter.CTkFont('Tahoma', size=15, weight="bold")
        )
